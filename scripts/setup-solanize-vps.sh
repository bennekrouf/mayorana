...
NEXT_PUBLIC_PLAUSIBLE_DOMAIN=ribh.io
...
echo -e "${GREEN}  sudo -u $APP_USER pm2 logs solanize-landing  — app logs${NC}"
echo -e "${GREEN}  sudo -u $APP_USER pm2 restart solanize-landing — restart app${NC}"
echo ""
