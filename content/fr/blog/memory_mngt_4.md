...
<div class="svg-container" style="margin:2rem 0;">
<svg class="mm4-fig2" viewBox="0 0 800 320" width="100%" style="height:auto;max-width:780px;display:block;margin:0 auto;" role="img" aria-label="Matrice des emprunts autorisés selon les emprunts déjà vivants, mettant en évidence le refus d'un emprunt mutable tant que des emprunts partagés existent">
<style>
...
<text x="425" y="122" text-anchor="middle" class="body">autorisé</text>
<text x="425" y="140" text-anchor="middle" class="cap">premier emprunt partagé</text>
<rect x="530" y="96" width="190" height="58" rx="8" class="box"/>
<text x="625" y="122" text-anchor="middle" class="body">autorisé</text>
<text x="625" y="140" text-anchor="middle" class="cap">accès exclusif</text>
<!-- row 2 -->
<text x="50" y="190" class="body">r1 = &amp;data, r2 = &amp;data</text>
<text x="50" y="208" class="cap">autant de partagés que voulu</text>
<rect x="330" y="162" width="190" height="58" rx="8" class="box"/>
<text x="425" y="188" text-anchor="middle" class="body">autorisé</text>
<text x="425" y="206" text-anchor="middle" class="cap">les partagés s'accumulent</text>
<rect x="530" y="162" width="190" height="58" rx="8" class="acbox"/>
<text x="625" y="188" text-anchor="middle" class="body ac">refusé</text>
<text x="625" y="206" text-anchor="middle" class="cap">cannot borrow as mutable</text>
<!-- row 3 -->
<text x="50" y="256" class="body">m = &amp;mut data</text>
<text x="50" y="274" class="cap">exactement un</text>
<rect x="330" y="228" width="190" height="58" rx="8" class="box"/>
<text x="425" y="254" text-anchor="middle" class="body">refusé</text>
<text x="425" y="272" text-anchor="middle" class="cap">déjà emprunté mutablement</text>
<rect x="530" y="228" width="190" height="58" rx="8" class="box"/>
<text x="625" y="254" text-anchor="middle" class="body">refusé</text>
<text x="625" y="272" text-anchor="middle" class="cap">un seul &amp;mut à la fois</text>
<!-- pointer to the highlighted cell -->
<path d="M760,191 L720,191" style="stroke:var(--ac)" marker-end="url(#mm4b-arrow-ac)"/>
<!-- caption -->
<text x="400" y="308" text-anchor="middle" class="cap">Dans l'exemple r1 et r2 sont encore vivants, donc `let r3 = &amp;mut data;` tombe dans la case surlignée.</text>
</svg>
</div>
